...
class SecurityPolicyNone(SecurityPolicy):
    ...
    def __init__(
        ...
        self.host_chain = [uacrypto.der_from_x509(cert) for cert in host_cert_chain]
...
class SecurityPolicyFactory:
    ...
    def __init__(self, cls, mode, certificate=None, private_key=None, permission_ruleset=None, host_cert_chain=None):
        self.cls = cls
        self.mode = mode
        self.certificate = certificate
        self.host_chain = host_cert_chain
    ...
    def create(self, peer_certificate):
        return self.cls(
            ...
            host_cert_chain=self.host_chain,
        )
